...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12 white-bg">
                <div class="pull-right button-add">
                    <a href="#" role="modal" class="btn btn-sm btn-primary" onclick="tambahLevel()"><i class="fa fa-plus"></i></a>
                </div>
    ...
    <div class="modal fade" id="modalLevel" tabindex="-1" role="dialog" aria-labelledby="modalLevelLabel">
            ...
            <div class="modal-content">
                ...
                <form id="frmLevel">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="kode">Nama Level</label>
                            <input type="text" name="nama_level" class="form-control" max-length="3">
                            <span class="text-danger">
...
<script>
    var frmModal = $('#modalLevel');
    var form = $('#frmLevel');
    var formAction, table, uid;
    var method = 'POST';
    var styles = {
        button: function(row, type, data) {
            return '<a href="#" role="modal" onclick="updateLevel('+data.id+')" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>&nbsp;<a href="#" class="btn btn-danger btn-sm" onclick="deleteLevel('+data.id+')"><i class="fa fa-trash"></i></a>';
        },
...
var mem = $('#data_1 .input-group.date').datepicker({
    ...
    var tambahLevel = function() {
        formAction = '{!! route('level.create') !!}';
        resetForm();
        frmModal.modal('show');
    }
